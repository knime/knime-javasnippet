...
/**
 * This class implements the configuration dialog and the fallback scripting editor for the Rule-based Row Filter node.
 *
 * @author Ali Asghar Marvi, KNIME GmbH, Berlin, Germany
 * @since 5.12
 */
@SuppressWarnings("restriction")
final class RuleEngineFilterScriptingNodeDialog extends AbstractDefaultScriptingNodeDialog {

    RuleEngineFilterScriptingNodeDialog() {
        super(RuleEngineFilterScriptingNodeParameters.class);
    }
    ...
    protected GenericInitialDataBuilder getInitialData(final NodeContext context) {
        ...
        return GenericInitialDataBuilder.createDefaultInitialDataBuilder(NodeContext.getContext()) //
            ...
            .addDataSupplier(WebUIDialogUtils.DATA_SUPPLIER_KEY_STATIC_COMPLETION_ITEMS, () -> WebUIDialogUtils
                .getCompletionItems(workflowControl, RuleManipulatorProvider.getProvider(), true));
    }
}
